...
class ClubClass extends SuitClass
{
    ...
    public ClubClass (int xNew, int yNew, int widthNew, Color colourNew)
    {
	x = xNew;
	y = yNew;
	setWidth (widthNew);
    ...
    {
	c.fillOval (x - width / 4, y - height / 2, width / 2, height / 2);
	c.fillOval (x - width / 2, y - height / 6, width / 2, height / 2);
	c.fillOval (x, y - height / 6, width / 2, height / 2);
